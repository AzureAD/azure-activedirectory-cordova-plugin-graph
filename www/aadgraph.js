...
var EncodingHelpers = require('cordova-plugin-ms-adal.utility').Utility.EncodingHelpers;
    ...
    (function (DirectoryServices) {
        (function (Extensions) {
            ...
            var DataContext = (function () {
                function DataContext(serviceRootUri, extraQueryParameters, authContext, resourceUrl, appId, redirectUrl) {
                    this._noCache = Date.now();
                    this.serviceRootUri = serviceRootUri;
                    this.extraQueryParameters = extraQueryParameters;
                    this._getAccessTokenFn = function () {
                        var d = new Deferred();
                ...
                DataContext.prototype.request = function (request) {
                    ...
                    request.requestUri = this.handlePath(request.requestUri);
                ...
                DataContext.prototype.augmentRequest = function (request) {
                    ...
                    if ((!this._disableCacheOverride && request.disableCache) || (this._disableCacheOverride && this._disableCache)) {
                        // Added these headers as additional parameter `_` (see below) is not recognized on server side
                        request.headers.Pragma = 'no-cache';
                        request.headers.Expires = 'Mon, 26 Jul 1997 05:00:00 GMT';
                        //request.requestUri += (request.requestUri.indexOf('?') >= 0 ? '&' : '?') + '_=' + this._noCache++;
                    }
                };

                DataContext.prototype.handlePath = function (path) {
                    path = path.replace(/\/\//g, '/');
            ...
            var PagedCollection = (function () {
                function PagedCollection(context, path, resultFn, data) {
                    ...
                    if (path) {
                        this._path = path.indexOf(context._serviceRootUri) != -1 ? path : context._serviceRootUri + '/' + path;
                    } else {
                        this._path = path;
                    }

                    if (this._path) {
                        this._path = this.context.handlePath(this._path);
                    }
                ...
                PagedCollection.prototype.getNextPage = function () {
                    ...
                    this.context.request(request).then((function (data) {
                        var parsedData = JSON.parse(data),
                            nextLink = (parsedData['odata.nextLink'] === undefined) ?
                                ((parsedData['@odata.nextLink'] === undefined) ?
                                    ((parsedData['__next'] === undefined) ? null : parsedData['__next'])
                                : parsedData['@odata.nextLink'])
                            : parsedData['odata.nextLink'];
            ...
            var CollectionQuery = (function () {
                ...
                CollectionQuery.prototype.fetchAll = function (maxItems) {
                    var path = this.path + (this._query ? (this.path.indexOf('?') < 0 ? '?' : '&') + this._query : ""), pagedItems = new Microsoft.DirectoryServices.Extensions.PagedCollection(this.context, path, this._resultFn), accumulator = [], deferred = new Deferred();
                    var recursive = function (nextPagedItems) {
                        if (!nextPagedItems) {
...
(function (Microsoft) {
    (function (DirectoryServices) {
        var ActiveDirectoryClient = (function () {
            function ActiveDirectoryClient(serviceRootUri, authContext, resourceUrl, appId, redirectUrl) {
                this._context = new Microsoft.DirectoryServices.Extensions.DataContext(serviceRootUri, "api-version=1.5", authContext, resourceUrl, appId, redirectUrl);
            }
            ...
            ActiveDirectoryClient.prototype.isMemberOf = function (groupId, memberId) {
                    var deferred = new Deferred(), request = new Microsoft.DirectoryServices.Extensions.Request(this.getPath("isMemberOf"));
        ...
        var DirectoryObjectFetcher = (function (_super) {
            ...
            DirectoryObjectFetcher.prototype.update_createdOnBehalfOf = function (value) {
                var deferred = new Deferred(), request = new Microsoft.DirectoryServices.Extensions.Request(this.getPath("$links/createdOnBehalfOf"));
            ...
            DirectoryObjectFetcher.prototype.update_manager = function (value) {
                var deferred = new Deferred(), request = new Microsoft.DirectoryServices.Extensions.Request(this.getPath("$links/manager"));
            ...
            DirectoryObjectFetcher.prototype.fetch = function () {
                ...
                this.context.readUrl(this.path).then((function (data) {
                    var parsedData = JSON.parse(data), path = _this.context.serviceRootUri + '/directoryObjects' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: parsedData.objectId }]);
            ...
            DirectoryObjectFetcher.prototype.checkMemberGroups = function (groupIds) {
                var deferred = new Deferred(), request = new Microsoft.DirectoryServices.Extensions.Request(this.getPath("checkMemberGroups"));
            ...
            DirectoryObjectFetcher.prototype.getMemberGroups = function (securityEnabledOnly) {
                var deferred = new Deferred(), request = new Microsoft.DirectoryServices.Extensions.Request(this.getPath("getMemberGroups"));
            ...
            DirectoryObjectFetcher.prototype.getMemberObjects = function (securityEnabledOnly) {
                var deferred = new Deferred(), request = new Microsoft.DirectoryServices.Extensions.Request(this.getPath("getMemberObjects"));
        ...
        var DirectoryObject = (function (_super) {
            ...
            DirectoryObject.prototype.addMember = function (entity) {
                var deferred = new Deferred(), request = new Microsoft.DirectoryServices.Extensions.Request(this.getPath('$links/members'));

                request.method = 'POST';

                request.data = JSON.stringify({ url: this.context.handlePath(entity.path) });

                this.context.request(request).then(function () {
                    deferred.resolve();
                }, deferred.reject.bind(deferred));
            ...
            DirectoryObject.prototype.deleteMember = function (entity) {
                var deferred = new Deferred(), request = new Microsoft.DirectoryServices.Extensions.Request(this.getPath('$links/members'));

                request.method = 'DELETE';

                request.requestUri = request.requestUri + '/' + entity.objectId;
            ...
            DirectoryObject.prototype.update = function () {
                var _this = this;
                var deferred = new Deferred(), request = new Microsoft.DirectoryServices.Extensions.Request(this.path);
        ...
        var ApplicationFetcher = (function (_super) {
            ...
            ApplicationFetcher.prototype.fetch = function () {
                ...
                this.context.readUrl(this.path).then((function (data) {
                    var parsedData = JSON.parse(data), path = _this.context.serviceRootUri + '/applications' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: parsedData.objectId }]);
            ...
            ApplicationFetcher.prototype.restore = function (identifierUris) {
                var _this = this;
                var deferred = new Deferred(), request = new Microsoft.DirectoryServices.Extensions.Request(this.getPath("restore"));
                ...
                this.context.request(request).then((function (data) {
                    var parsedData = JSON.parse(data);
                    var path = _this.context.serviceRootUri + '/applications' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: parsedData.objectId }]);
                    deferred.resolve(Application.parseApplication(_this.context, path, parsedData));
                }).bind(this), deferred.reject.bind(deferred));
        ...
        var Application = (function (_super) {
            ...
            Object.defineProperty(Application.prototype, "identifierUris", {
                ...
                set: function (value) {
                    if (value !== this._identifierUris) {
                        this._identifierUrisChanged = true;
                        this.changed = true;
                    }
            ...
            Application.prototype.restore = function (identifierUris) {
                var _this = this;
                var requestPath = _this.context.serviceRootUri + '/' + 'deletedApplications/' + _this.objectId + '/restore';
                var deferred = new Deferred(),
                    request = new Microsoft.DirectoryServices.Extensions.Request(requestPath);
            ...
            Application.prototype.getRequestBody = function () {
                return {
                    ...
                    availableToOtherTenants: (this.availableToOtherTenantsChanged && typeof(this.availableToOtherTenants) !== 'undefined') ? this.availableToOtherTenants : undefined,
                    ...
                    oauth2AllowImplicitFlow: (this.oauth2AllowImplicitFlowChanged && typeof(this.oauth2AllowImplicitFlow) !== 'undefined') ? this.oauth2AllowImplicitFlow : undefined,
                    oauth2AllowUrlPathMatching: (this.oauth2AllowUrlPathMatchingChanged && typeof(this.oauth2AllowUrlPathMatching) !== 'undefined') ? this.oauth2AllowUrlPathMatching : undefined,
                    ...
                    publicClient: (this.publicClientChanged && typeof(this.publicClient) !== 'undefined') ? this.publicClient : undefined,
        ...
        var UserFetcher = (function (_super) {
            ...
            UserFetcher.prototype.fetch = function () {
                ...
                this.context.readUrl(this.path).then((function (data) {
                    var parsedData = JSON.parse(data), path = _this.context.serviceRootUri + '/users' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: parsedData.objectId }]);
            ...
            UserFetcher.prototype.assignLicense = function (addLicenses, removeLicenses) {
                var _this = this;
                var deferred = new Deferred(), request = new Microsoft.DirectoryServices.Extensions.Request(this.getPath("assignLicense"));
                ...
                this.context.request(request).then((function (data) {
                    var parsedData = JSON.parse(data);
                    var path = _this.context.serviceRootUri + '/users' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: parsedData.objectId }]);
                    deferred.resolve(User.parseUser(_this.context, path, parsedData));
                }).bind(this), deferred.reject.bind(deferred));
        ...
        var User = (function (_super) {
            ...
            User.prototype.assignLicense = function (addLicenses, removeLicenses) {
                var _this = this;
                var deferred = new Deferred(),
                    request = new Microsoft.DirectoryServices.Extensions.Request(this.getPath("assignLicense"));
            ...
            User.prototype.update = function () {
                ...
                for (var propName in this) {
                    if (this.hasOwnProperty(propName)) {
                        if (propName.indexOf('extension') > -1) {
                            extensions.push(propName);
                        }
                    }
                }
                ...
                for (var extension in extensions) {
                    requestBody[extensions[extension]] = this[extensions[extension]];
                }
                request.data = JSON.stringify(requestBody);

                this.context.request(request).then(function (data) {
                    /* https://msdn.microsoft.com/en-us/library/azure/dn151671.aspx
            ...
            User.prototype.delete = function () {
                var deferred = new Deferred(),
                    request = new Microsoft.DirectoryServices.Extensions.Request(this.path);
            ...
            User.prototype.getRequestBody = function () {
                return {
                    accountEnabled: (this.accountEnabledChanged && typeof(this.accountEnabled) !== 'undefined') ? this.accountEnabled : undefined,
                    ...
                    dirSyncEnabled: (this.dirSyncEnabledChanged && typeof(this.dirSyncEnabled) !== 'undefined') ? this.dirSyncEnabled : undefined,
                    displayName: (this.displayNameChanged && this.displayName) ? this.displayName : undefined,
        ...
        var ExtensionPropertyFetcher = (function (_super) {
            ...
            ExtensionPropertyFetcher.prototype.fetch = function () {
                ...
                this.context.readUrl(this.path).then((function (data) {
                    var parsedData = JSON.parse(data), path = _this.context.serviceRootUri + '/extensionProperties' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: parsedData.objectId }]);
        ...
        var ExtensionProperty = (function (_super) {
            ...
            Object.defineProperty(ExtensionProperty.prototype, "targetObjects", {
                ...
                set: function (value) {
                    if (value !== this._targetObjects) {
                        this._targetObjectsChanged = true;
                        this.changed = true;
                    }
            ...
            ExtensionProperty.prototype.getRequestBody = function () {
                return {
                    ...
                    isSyncedFromOnPremises: (this.isSyncedFromOnPremisesChanged && typeof(this.isSyncedFromOnPremises) !== 'undefined') ? this.isSyncedFromOnPremises : undefined,
        ...
        var AppRole = (function (_super) {
            ...
            AppRole.prototype.getRequestBody = function () {
                return {
                    ...
                    isEnabled: (this.isEnabledChanged && typeof(this.isEnabled) !== 'undefined') ? this.isEnabled : undefined,
        ...
        var ContactFetcher = (function (_super) {
            ...
            ContactFetcher.prototype.fetch = function () {
                ...
                this.context.readUrl(this.path).then((function (data) {
                    var parsedData = JSON.parse(data), path = _this.context.serviceRootUri + '/contacts' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: parsedData.objectId }]);
        ...
        var ProvisioningError = (function (_super) {
            ...
            ProvisioningError.prototype.getRequestBody = function () {
                return {
                    ...
                    resolved: (this.resolvedChanged && typeof(this.resolved) !== 'undefined') ? this.resolved : undefined,
        ...
        var DeviceFetcher = (function (_super) {
            ...
            DeviceFetcher.prototype.fetch = function () {
                ...
                this.context.readUrl(this.path).then((function (data) {
                    var parsedData = JSON.parse(data), path = _this.context.serviceRootUri + '/devices' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: parsedData.objectId }]);
        ...
        var Device = (function (_super) {
            ...
            Object.defineProperty(Device.prototype, "alternativeSecurityIds", {
                ...
                set: function (value) {
                    if (value !== this._alternativeSecurityIds) {
                        this._alternativeSecurityIdsChanged = true;
                        this.changed = true;
                    }
        ...
        var DeviceConfigurationFetcher = (function (_super) {
            ...
            DeviceConfigurationFetcher.prototype.fetch = function () {
                ...
                this.context.readUrl(this.path).then((function (data) {
                    var parsedData = JSON.parse(data), path = _this.context.serviceRootUri + '/deviceConfigurations' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: parsedData.objectId }]);
        ...
        var DirectoryLinkChangeFetcher = (function (_super) {
            ...
            DirectoryLinkChangeFetcher.prototype.fetch = function () {
                ...
                this.context.readUrl(this.path).then((function (data) {
                    var parsedData = JSON.parse(data), path = _this.context.serviceRootUri + '/directoryLinkChanges' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: parsedData.objectId }]);
        ...
        var AppRoleAssignmentFetcher = (function (_super) {
            ...
            AppRoleAssignmentFetcher.prototype.fetch = function () {
                ...
                this.context.readUrl(this.path).then((function (data) {
                    var parsedData = JSON.parse(data), path = _this.context.serviceRootUri + '/appRoleAssignments' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: parsedData.objectId }]);
        ...
        var GroupFetcher = (function (_super) {
            ...
            GroupFetcher.prototype.fetch = function () {
                ...
                this.context.readUrl(this.path).then((function (data) {
                    var parsedData = JSON.parse(data), path = _this.context.serviceRootUri + '/groups' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: parsedData.objectId }]);
        ...
        var Group = (function (_super) {
            ...
            Group.prototype.update = function () {
                ...
                this.context.request(request).then(function (data) {
                    ...
                    /* https://msdn.microsoft.com/en-us/library/azure/dn151602.aspx
                       A successful operation returns status code 204 No Content. */
                    deferred.resolve();
                }, deferred.reject.bind(deferred));
            ...
            Group.prototype.getRequestBody = function () {
                return {
                    ...
                    mail: (this.mailChanged && this.mail) ? this.mail : undefined,
                    mailNickname: (this.mailNicknameChanged && this.mailNickname) ? this.mailNickname : undefined,
                    mailEnabled: (this.mailEnabledChanged && typeof(this.mailEnabled) !== 'undefined') ? this.mailEnabled : undefined,
                    onPremisesSecurityIdentifier: (this.onPremisesSecurityIdentifierChanged && this.onPremisesSecurityIdentifier) ? this.onPremisesSecurityIdentifier : undefined,
                    provisioningErrors: (this.provisioningErrorsChanged) ? (function (provisioningErrors) {
                        if (!provisioningErrors) {
                            return undefined;
                    ...
                    proxyAddresses: (this.proxyAddressesChanged && this.proxyAddresses) ? this.proxyAddresses : undefined,
                    securityEnabled: (this.securityEnabledChanged && typeof(this.securityEnabled) !== 'undefined') ? this.securityEnabled : undefined,
                    objectType: (this.objectTypeChanged && this.objectType) ? this.objectType : undefined,
                    objectId: (this.objectIdChanged && this.objectId) ? this.objectId : undefined,
                    deletionTimestamp: (this.deletionTimestampChanged && this.deletionTimestamp) ? this.deletionTimestamp.toString() : undefined,
                    'odata.type': this._odataType
        ...
        var DirectoryRoleFetcher = (function (_super) {
            ...
            DirectoryRoleFetcher.prototype.fetch = function () {
                ...
                this.context.readUrl(this.path).then((function (data) {
                    var parsedData = JSON.parse(data), path = _this.context.serviceRootUri + '/directoryRoles' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: parsedData.objectId }]);
        ...
        var DirectoryRole = (function (_super) {
            ...
            DirectoryRole.prototype.getRequestBody = function () {
                return {
                    description: (this.descriptionChanged && this.description) ? this.description : undefined,
                    displayName: (this.displayNameChanged && this.displayName) ? this.displayName : undefined,
                    isSystem: (this.isSystemChanged && typeof(this.isSystem) !== 'undefined') ? this.isSystem : undefined,
                    roleDisabled: (this.roleDisabledChanged && typeof(this.roleDisabled) !== 'undefined') ? this.roleDisabled : undefined,
        ...
        var DirectoryRoleTemplateFetcher = (function (_super) {
            ...
            DirectoryRoleTemplateFetcher.prototype.fetch = function () {
                ...
                this.context.readUrl(this.path).then((function (data) {
                    var parsedData = JSON.parse(data), path = _this.context.serviceRootUri + '/directoryRoleTemplates' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: parsedData.objectId }]);
        ...
        var ServicePrincipalFetcher = (function (_super) {
            ...
            ServicePrincipalFetcher.prototype.fetch = function () {
                ...
                this.context.readUrl(this.path).then((function (data) {
                    var parsedData = JSON.parse(data), path = _this.context.serviceRootUri + '/servicePrincipals' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: parsedData.objectId }]);
        ...
        var ServicePrincipal = (function (_super) {
            ...
            ServicePrincipal.prototype.getRequestBody = function () {
                return {
                    ...
                    appRoleAssignmentRequired: (this.appRoleAssignmentRequiredChanged && typeof(this.appRoleAssignmentRequired) !== 'undefined') ? this.appRoleAssignmentRequired : undefined,
                    appRoles: (this.appRolesChanged) ? (function (appRoles) {
                        if (!appRoles) {
                            return undefined;
                        }
        ...
        var TenantDetailFetcher = (function (_super) {
            ...
            TenantDetailFetcher.prototype.fetch = function () {
                ...
                this.context.readUrl(this.path).then((function (data) {
                    var parsedData = JSON.parse(data), path = _this.context.serviceRootUri + '/tenantDetails' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: parsedData.objectId }]);
        ...
        var TenantDetail = (function (_super) {
            ...
            Object.defineProperty(TenantDetail.prototype, "marketingNotificationEmails", {
                ...
                set: function (value) {
                    if (value !== this._marketingNotificationEmails) {
                        this._marketingNotificationEmailsChanged = true;
                        this.changed = true;
                    }
            ...
            Object.defineProperty(TenantDetail.prototype, "technicalNotificationMails", {
                ...
                set: function (value) {
                    if (value !== this._technicalNotificationMails) {
                        this._technicalNotificationMailsChanged = true;
                        this.changed = true;
                    }
        ...
        var VerifiedDomain = (function (_super) {
            ...
            VerifiedDomain.prototype.getRequestBody = function () {
                return {
                    ...
                    default: (this.defaultChanged && typeof(this.default) !== 'undefined') ? this.default : undefined,
                    id: (this.idChanged && this.id) ? this.id : undefined,
                    initial: (this.initialChanged && typeof(this.initial) !== 'undefined') ? this.initial : undefined,
                    name: (this.nameChanged && this.name) ? this.name : undefined,
                    type: (this.typeChanged && this.type) ? this.type : undefined,
                    'odata.type': this._odataType
                };
        ...
        var PasswordProfile = (function (_super) {
            ...
            PasswordProfile.prototype.getRequestBody = function () {
                return {
                    ...
                    forceChangePasswordNextLogin: (this.forceChangePasswordNextLoginChanged && typeof(this.forceChangePasswordNextLogin) !== 'undefined') ? this.forceChangePasswordNextLogin : undefined,
                    'odata.type': this._odataType
                };
            };
        ...
        var OAuth2PermissionGrantFetcher = (function (_super) {
            ...
            OAuth2PermissionGrantFetcher.prototype.fetch = function () {
                ...
                this.context.readUrl(this.path).then((function (data) {
                    var parsedData = JSON.parse(data), path = _this.context.serviceRootUri + '/oauth2PermissionGrants' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: parsedData.objectId }]);
        ...
        var SubscribedSkuFetcher = (function (_super) {
            ...
            SubscribedSkuFetcher.prototype.fetch = function () {
                ...
                this.context.readUrl(this.path).then((function (data) {
                    var parsedData = JSON.parse(data), path = _this.context.serviceRootUri + '/subscribedSkus' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: parsedData.objectId }]);
        ...
        var DirectoryObjects = (function (_super) {
            ...
            function DirectoryObjects(context, path, entity) {
                ...
                this._parseCollectionFn = function (context, data) {
                    var pathFn = function (data) {
                        return _this.context.serviceRootUri + '/directoryObjects' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: data.objectId }]);
                    };
            ...
            DirectoryObjects.prototype.getDirectoryObject = function (objectId) {
                var path = this.path + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: objectId }]);
            ...
            DirectoryObjects.prototype.addDirectoryObject = function (item) {
                ...
                if (this.entity == null) {
                    ...
                    this.context.request(request).then((function (data) {
                            var parsedData = JSON.parse(data), objectPath = _this.path + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: parsedData.objectId }]);
            ...
            DirectoryObjects.prototype.asApplications = function () {
                ...
                var parseCollectionFn = (function (context, data) {
                    var pathFn = function (data) {
                        return _this.context.serviceRootUri + '/applications' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: data.objectId }]);
                    };
            ...
            DirectoryObjects.prototype.asUsers = function () {
                ...
                var parseCollectionFn = (function (context, data) {
                    var pathFn = function (data) {
                        return _this.context.serviceRootUri + '/users' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: data.objectId }]);
                    };
            ...
            DirectoryObjects.prototype.asExtensionProperties = function () {
                ...
                var parseCollectionFn = (function (context, data) {
                    var pathFn = function (data) {
                        return _this.context.serviceRootUri + '/extensionProperties' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: data.objectId }]);
                    };
            ...
            DirectoryObjects.prototype.asContacts = function () {
                ...
                var parseCollectionFn = (function (context, data) {
                    var pathFn = function (data) {
                        return _this.context.serviceRootUri + '/contacts' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: data.objectId }]);
                    };
            ...
            DirectoryObjects.prototype.asDevices = function () {
                ...
                var parseCollectionFn = (function (context, data) {
                    var pathFn = function (data) {
                        return _this.context.serviceRootUri + '/devices' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: data.objectId }]);
                    };
            ...
            DirectoryObjects.prototype.asDeviceConfigurations = function () {
                ...
                var parseCollectionFn = (function (context, data) {
                    var pathFn = function (data) {
                        return _this.context.serviceRootUri + '/deviceConfigurations' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: data.objectId }]);
                    };
            ...
            DirectoryObjects.prototype.asDirectoryLinkChanges = function () {
                ...
                var parseCollectionFn = (function (context, data) {
                    var pathFn = function (data) {
                        return _this.context.serviceRootUri + '/directoryLinkChanges' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: data.objectId }]);
                    };
            ...
            DirectoryObjects.prototype.asAppRoleAssignments = function () {
                ...
                var parseCollectionFn = (function (context, data) {
                    var pathFn = function (data) {
                        return _this.context.serviceRootUri + '/appRoleAssignments' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: data.objectId }]);
                    };
            ...
            DirectoryObjects.prototype.asGroups = function () {
                ...
                var parseCollectionFn = (function (context, data) {
                    var pathFn = function (data) {
                        return _this.context.serviceRootUri + '/groups' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: data.objectId }]);
                    };
            ...
            DirectoryObjects.prototype.asDirectoryRoles = function () {
                ...
                var parseCollectionFn = (function (context, data) {
                    var pathFn = function (data) {
                        return _this.context.serviceRootUri + '/directoryRoles' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: data.objectId }]);
                    };
            ...
            DirectoryObjects.prototype.asDirectoryRoleTemplates = function () {
                ...
                var parseCollectionFn = (function (context, data) {
                    var pathFn = function (data) {
                        return _this.context.serviceRootUri + '/directoryRoleTemplates' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: data.objectId }]);
                    };
            ...
            DirectoryObjects.prototype.asServicePrincipals = function () {
                ...
                var parseCollectionFn = (function (context, data) {
                    var pathFn = function (data) {
                        return _this.context.serviceRootUri + '/servicePrincipals' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: data.objectId }]);
                    };
            ...
            DirectoryObjects.prototype.asTenantDetails = function () {
                ...
                var parseCollectionFn = (function (context, data) {
                    var pathFn = function (data) {
                        return _this.context.serviceRootUri + '/tenantDetails' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: data.objectId }]);
                    };
        ...
        var OAuth2PermissionGrants = (function (_super) {
            ...
            function OAuth2PermissionGrants(context, path, entity) {
                ...
                this._parseCollectionFn = function (context, data) {
                    var pathFn = function (data) {
                        return _this.context.serviceRootUri + '/oauth2PermissionGrants' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: data.objectId }]);
                    };
        ...
        var SubscribedSkus = (function (_super) {
            ...
            function SubscribedSkus(context, path, entity) {
                ...
                this._parseCollectionFn = function (context, data) {
                    var pathFn = function (data) {
                        return _this.context.serviceRootUri + '/subscribedSkus' + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: data.objectId }]);
                    };
            ...
            SubscribedSkus.prototype.addSubscribedSku = function (item) {
                ...
                if (this.entity == null) {
                    ...
                    this.context.request(request).then((function (data) {
                        var parsedData = JSON.parse(data), objectPath = _this.path + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: data.objectId }]);
        ...
        var AppRoleAssignments = (function (_super) {
            ...
            AppRoleAssignments.prototype.addAppRoleAssignment = function (item) {
                ...
                if (this.entity == null) {
                    ...
                    this.context.request(request).then((function (data) {
                        var parsedData = JSON.parse(data),
                            objectPath = _this.path + EncodingHelpers.getKeyExpression([{ name: "objectId", type: "Edm.String", value: parsedData.objectId }]);
...
module.exports = Microsoft.DirectoryServices;
